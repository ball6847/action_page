...
<head>
    ...
    <!-- Styles -->
    <link rel="stylesheet" type="text/css" href="js_page/views/script/styles.css"/>
...
<body>
    ...
    <!-- Scripts -->
    <script src="js_page/views/script/libraries.min.js"></script>
    <script src="js_page/views/script/jquery.parallax.js"></script>
    <script>
